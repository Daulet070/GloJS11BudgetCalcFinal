...
const additIncomeItem1 = document.querySelectorAll('.additional_income-item')[0];
const additIncomeItem2 = document.querySelectorAll('.additional_income-item')[1];
const budgetMonthValue = document.getElementsByClassName('budget_month-value')[0];
const budgetDayValue = document.getElementsByClassName('budget_day-value')[0];
const expensesMonthValue1 = document.getElementsByClassName('expenses_month-value')[0];
const expensesMonthValue2 = document.getElementsByClassName('expenses_month-value')[0];
